...
export function useCalculate() {
  ...
  const { monthRows, financialIndependenceMonth, monthReachOneMillion } =
    useMemo(() => {
        ...
        if (
          ...
          if (DEBUG) {
            console.log({
              ...
              person1BaseSocialSecurity: formatPennies(
                person1BaseSocialSecurity
              ),
              person2BaseSocialSecurity: formatPennies(
                person2BaseSocialSecurity
              ),
              ...
              incomeNeededFromPortfolio: formatPennies(
                incomeNeededFromPortfolio
              ),
      ...
      return { monthRows, financialIndependenceMonth, monthReachOneMillion }
    }, [
      adjustForInflation,
      baseSocialSecurity,
